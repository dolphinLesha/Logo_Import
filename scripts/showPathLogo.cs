...
public class showPathLogo : MonoBehaviour
{
    ...
    {
        fullPath.GetComponentInChildren<Text>().text = folderBrowserLogo._folderBrowserLogo.currentPath;
    }
    ...
    IEnumerator showIm()
    {
        while (t < 2 && flag)
        {
            if (t == 1 && flag)
            {
                ...
                isShowing = true;
                fullPath.GetComponentInChildren<Text>().text = folderBrowserLogo._folderBrowserLogo.currentPath;
                if (folderBrowserLogo._folderBrowserLogo.currentPath.Length > 57)
                {
                ...
                if (folderBrowserLogo._folderBrowserLogo.currentPath.Length > 114)
                {
                    fullPath.rectTransform.offsetMax = new Vector2(0, 20);
